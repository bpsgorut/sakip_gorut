...
@section('content')
    ...
    <div class="container mx-auto py-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Manajemen Lakin</h1>
                <p class="text-sm text-gray-500 mt-1">Kelola dokumen laporan kinerja untuk evaluasi dan akuntabilitas kinerja organisasi
                </p>
            </div>
            @if($isSuperAdmin)
            <div class="justify-end">
                <button id="btnTambahKegiatan"
                    ...
                    <svg xmlns="h http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 transition-transform group-hover:rotate-90"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900 mb-2">Belum ada kegiatan Lakin</h3>
                                        <p class="text-gray-500 mb-4 max-w-md text-center">Mulai dengan menambahkan kegiatan Laporan Kinerja untuk tahun {{ date('Y') }}</p>
                                        @if($isSuperAdmin)
    ...
    <div id="modalTambahKegiatan" class="fixed inset-0 z-50 flex items-center justify-center hidden">
            ...
            <div class="p-5">
                <div class="relative border-b pb-3 mb-4">
                    <div class="flex justify-center">
                        <h3 class="text-lg font-bold text-gray-900">Tambah Kegiatan</h3>
                    </div>
                ...
                <form action="{{ route('kegiatan.store') }}" method="POST" id="formModalKegiatan">
                    ...
                    <!-- HIDDEN INPUTS -->
                    <input type="hidden" name="jenis_kegiatan" value="lakin">
                    <input type="hidden" name="renstra_id" value="{{ $activeRenstra->id ?? '' }}">
                    <input type="hidden" name="sub_komponen_id" value="{{ $lakinSubKomponen->id ?? '' }}">

                    <!-- Nama Kegiatan (Read Only) -->
                    <div class="mb-4">
                        <label for="nama_kegiatan" class="block text-sm font-bold mb-1">Nama Kegiatan</label>
                        <input type="text" id="nama_kegiatan" name="nama_kegiatan" value="Laporan Kinerja"
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const btnTambahKegiatanFirst = document.getElementById('btnTambahKegiatanFirst');
            ...
            if (btnTambahKegiatanFirst) {
                btnTambahKegiatanFirst.addEventListener('click', openModal);
            }
            ...
            if (tanggalMulai && tanggalBerakhir) {
                ...
                tanggalBerakhir.addEventListener('change', function() {
            ...
            if(modalEditOverlay) modalEditOverlay.addEventListener('click', closeEditModal);
