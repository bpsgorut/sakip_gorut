...
@section('content')
    ...
    <div class="container mx-auto py-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Surat Keputusan Tim SAKIP</h1>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors"
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('detail', ['id' => $kegiatan->id, 'year' => $kegiatan->tahun_berjalan]) }}"
                                        ...
                                        title="Lihat Detail SK Tim SAKIP">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900 mb-2">Belum ada SK Tim SAKIP</h3>
                                        <p class="text-gray-500 mb-4 max-w-md text-center">Mulai dengan menambahkan Surat Keputusan Tim SAKIP untuk tahun {{ date('Y') }}</p>
                                        @if($isSuperAdmin)
            ...
            <div class="p-5">
                <div class="relative border-b pb-3 mb-4">
                    <div class="flex justify-center">
                        <h3 class="text-lg font-bold text-red-600">Tambah Perjanjian Kinerja</h3>
                    </div>
                ...
                <form action="{{ route('kegiatan.store') }}" method="POST">
                    @csrf
                    <!-- HIDDEN INPUTS -->
                    <input type="hidden" name="jenis_kegiatan" id="jenis_kegiatan" value="sk_tim_sakip">
                    ...
                    @php
                        ...
                        if (isset($SkTimSakipSubKomponen) && $SkTimSakipSubKomponen) {
                            $SkTimSakipId = $SkTimSakipSubKomponen->id;
                        } else {
                            ...
                            if ($found) {
                                $SkTimSakipId = $found->id;
                            }
                        }
                    @endphp

                    <input type="hidden" name="sub_komponen_id" value="{{ $SkTimSakipId }}">

                    <!-- Nama Kegiatan (Read Only) -->
                    <div class="mb-4">
                        <label for="nama_kegiatan" class="block text-sm font-bold mb-1">Nama Kegiatan</label>
                        <input type="text" id="nama_kegiatan" name="nama_kegiatan" value="Surat Keputusan Tim SAKIP"
